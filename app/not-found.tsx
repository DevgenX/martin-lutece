  ...
  return (
    <div className="page home">
      ...
      <div className="container" style={{ padding: "96px 56px 120px", maxWidth: 720 }}>
        ...
        <p style={{ fontSize: 17, lineHeight: "28px", margin: "24px 0 32px", color: "rgba(32,30,29,.8)" }}>The Summons did not reach it, or it never existed. Try the archive or head home.</p>
